...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-items/{work_item_id}/activities/</span>
</div>
...
<CodePanel title="List all work item activity" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
